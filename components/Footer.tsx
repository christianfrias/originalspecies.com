...
function Footer() {
  return (
    <footer>
      <div className="sm:flex sm:items-center sm:justify-between gap-10 px-4 py-12 bg-slate-100">
      ...
      <div className="sm:flex sm:items-center sm:justify-between px-4 py-6">
        <div className="block text-sm text-gray-500 sm:text-center dark:text-gray-400">
          © {new Date().getFullYear()} Christian Frias. All Rights Reserved.
        </div>
        <div className="flex mt-4 space-x-3 sm:justify-center sm:mt-0">
          ...
          {/* LinkedIn */}
          <a
            href="https://www.linkedin.com/in/originalspecies"
            target="_blank"
            rel="noreferrer"
            className="text-gray-500 hover:text-gray-900 dark:hover:text-white"
          >
          ...
          {/* Instagram */}
          <a
            href="https://www.instagram.com/chr.frias/"
            target="_blank"
            rel="noreferrer"
            className="text-gray-500 hover:text-gray-900 dark:hover:text-white"
          >
          ...
          {/* YouTube */}
          <a
            href="https://www.youtube.com/c/originalspeciesfilms"
            target="_blank"
            rel="noreferrer"
            className="text-gray-500 hover:text-gray-900 dark:hover:text-white"
          >
