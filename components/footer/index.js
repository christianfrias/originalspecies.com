...
function Footer() {
  return (
    <div>
      <footer>
        <div className="sm:flex sm:items-center sm:justify-between gap-10 px-8 py-12 bg-slate-100">
        ...
        <div className="sm:flex sm:items-center sm:justify-between px-8 py-6">
